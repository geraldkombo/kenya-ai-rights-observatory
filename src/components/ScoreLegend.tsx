export default function ScoreLegend() {
  return (
    <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-[11px] text-brand-muted sm:text-xs">
      ...
      <span className="ml-auto text-brand-muted">Digital Rights Risk Score</span>
    </div>
  );
}
